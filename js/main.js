...
var clubProjects = {
  campuseye: { title: 'CampusEye', category: 'Computer Vision', status: 'In progress', team: '4 contributors', focus: 'Smart campus', challenge: 'Smart Campus AI Challenge 2026', achievement: '1st Place', problem: 'Students lose time searching for available study seats, while continuous camera monitoring can introduce privacy concerns.', solution: 'A privacy-aware computer-vision pipeline counts occupied zones without identifying individuals and publishes only availability data to a lightweight dashboard.', learning: 'Demonstrates object detection, responsible data handling, model evaluation and the connection between an AI pipeline and a usable web interface.', icon: 'bi-camera-video', cover: 'cover-vision', tags: ['AI', 'CNN', 'Dashboard'], tech: ['Python', 'CNN', 'OpenCV', 'JavaScript'], description: 'CampusEye explores a camera-assisted seat availability system for a university library. A computer-vision pipeline would detect occupied and free seating zones and publish the result to a lightweight web dashboard.', features: ['Seat occupancy detection', 'Privacy-aware zone counting', 'Live dashboard concept', 'Mobile-friendly status view'], contributors: ['Vision Team', 'Front-End Team', 'Project Mentor'], videoId: 'nif7FQgB_14', videoDescription: 'This external learning video demonstrates passenger and seat-occupancy detection. It is a related example of visual analysis, not footage or a demo produced by the CampusEye team.' },
  studybuddy: { title: 'StudyBuddy GPT', category: 'NLP · RAG', status: 'Shipped concept', team: '3 contributors', focus: 'Learning assistant', challenge: 'Smart Campus AI Challenge 2026', achievement: '2nd Place', problem: 'Students need quick explanations but general chatbots may answer without using approved course material or showing where claims came from.', solution: 'A retrieval-augmented assistant searches faculty notes first, then generates a focused answer with source references for verification.', learning: 'Shows how embeddings, retrieval and LLM generation work together, and why grounding and citations improve trust in educational AI.', icon: 'bi-chat-square-text', cover: 'cover-nlp', tags: ['LLM', 'RAG', 'Citations'], tech: ['Python', 'RAG', 'Embeddings', 'LLM'], description: 'StudyBuddy GPT is a retrieval-augmented study assistant concept that searches approved faculty notes before generating an answer. The design focuses on source-aware responses so students can trace where an explanation came from.', features: ['Document retrieval', 'Source citations', 'Revision Q&A', 'Conversation history'], contributors: ['NLP Developer', 'UI Developer', 'Content Reviewer'], videoId: 'LpKGm1jJXv4', videoDescription: 'This external learning video explains Retrieval-Augmented Generation. It illustrates the underlying method used by StudyBuddy GPT and is not the team’s own project demonstration.' },
  clubmatch: { title: 'ClubMatch', category: 'Recommender', status: 'Shipped concept', team: '3 contributors', focus: 'Student discovery', challenge: 'Smart Campus AI Challenge 2026', achievement: '3rd Place', problem: 'New students face information overload when choosing clubs and may miss communities that match their interests and preferred activities.', solution: 'A recommender ranks campus clubs using stated interests, activity preferences and similarity signals, then explains the reason behind each match.', learning: 'Introduces feature representation, similarity scoring, ranking and explainability through a relatable campus recommendation problem.', icon: 'bi-people', cover: 'cover-match', tags: ['ML', 'Ranking', 'Campus'], tech: ['Python', 'Similarity', 'Ranking', 'Bootstrap'], description: 'ClubMatch recommends campus clubs based on interests, activity preferences and similarity signals. It demonstrates how a recommendation workflow can reduce information overload for new students.', features: ['Interest matching', 'Ranked recommendations', 'Explainable match reasons', 'Responsive results'], contributors: ['ML Developer', 'Data Analyst', 'UI Developer'], videoId: 'v90un9ALRzw', videoDescription: 'This external learning video introduces content-based and collaborative filtering. It is a related explanation of recommendation methods, not a ClubMatch team demo.' },
